...
public class SagaConfiguration {
  ...
  @Bean
  SagaProcessor defaultSagaProcessor(SagaRepository sagaRepository, Registry registry) {
    return new DefaultSagaProcessor(sagaRepository, registry, Optional.empty());
  }
}
