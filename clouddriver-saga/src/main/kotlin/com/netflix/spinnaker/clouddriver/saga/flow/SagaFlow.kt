...
class SagaFlow {
  ...
  internal inner class ActionStep(val action: Class<out SagaAction<*>>) : Step
  internal inner class ConditionStep(val predicate: Class<out Predicate<Saga>>, val nestedBuilder: SagaFlow) : Step
}
