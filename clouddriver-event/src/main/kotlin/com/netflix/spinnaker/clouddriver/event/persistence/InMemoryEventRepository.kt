...
class InMemoryEventRepository(
  ...
  override fun listAggregates(criteria: EventRepository.ListAggregatesCriteria): EventRepository.ListAggregatesResponse {
    ...
    return EventRepository.ListAggregatesResponse(
      aggregates = result,
