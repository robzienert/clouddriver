 ...
 *   Result apply(LoadFront50AppCommand command, Saga saga) {
 *     return Result(
 *       new LoadFront50App.LoadFront50AppCommand(
 *         "clouddriver",
 *         new MyNextCommand()
 *       ),
 ...
 * }
 *
 * class MyNextAction : SagaAction<MyNextAction.LoadFront50AppCommand> {
 *
 *   // MyNextAction implements an interface to mark it knows about this action
 *   static class LoadFront50AppCommand extends SagaCommand implements Front50AppAware {
 *
 *   }
 * }
 * }</pre>
