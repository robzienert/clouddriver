...
import static com.netflix.spinnaker.clouddriver.titus.deploy.actions.AttachTitusServiceLoadBalancers.*;
import static com.netflix.spinnaker.clouddriver.titus.deploy.actions.CopyTitusServiceScalingPolicies.*;
...
public class SubmitTitusJob implements SagaAction<SubmitTitusJob.SubmitTitusJobCommand> {
  ...
  @Getter
  public static class SubmitTitusJobCommand extends SagaCommand
      implements LoadFront50App.Front50AppAware {
